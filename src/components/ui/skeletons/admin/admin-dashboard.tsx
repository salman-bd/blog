...
import { PostsTabSkeleton } from "@/components/admin/posts-tab-skeleton"
import { CategoriesTabSkeleton } from "@/components/admin/categories-tab-skeleton"
import { CommentsTabSkeleton } from "@/components/admin/comments-tab-skeleton"
import { UsersTabSkeleton } from "@/components/admin/users-tab-skeleton"
import { SettingsTabSkeleton } from "@/components/admin/settings-tab-skeleton"
    ...
    <div className="container py-12 md:py-20 max-w-7xl mx-auto px-4 md:px-6">
      ...
      <Tabs defaultValue="posts" value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="posts">
          <Suspense fallback={<PostsTabSkeleton />}>
            <PostsTab />
          </Suspense>
        </TabsContent>

        <TabsContent value="categories">
          <Suspense fallback={<CategoriesTabSkeleton />}>
            <CategoriesTab />
          </Suspense>
        </TabsContent>
        ...
        <TabsContent value="users">
          <Suspense fallback={<UsersTabSkeleton />}>
            <UsersTab />
          </Suspense>
        </TabsContent>
